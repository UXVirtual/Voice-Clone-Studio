...
def generate_custom_voice(text_to_generate, language, speaker, instruct, seed, progress=gr.Progress()):
    ...
    try:
        ...
        progress(0.1, desc="Loading CustomVoice model...")
...
def generate_conversation(conversation_data, pause_duration, language, seed, progress=gr.Progress()):
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("🎭 Custom Voice"):
                ...
                custom_generate_btn.click(
                    lambda text, lang, speaker_sel, instruct, seed, progress=gr.Progress(): generate_custom_voice(text, lang, extract_speaker_name(speaker_sel), instruct, seed, progress),
                    inputs=[custom_text_input, custom_language, custom_speaker_dropdown, custom_instruct_input, custom_seed],
...
Aiden: Mind if I join this conversation?""",
                ...
                conv_generate_btn.click(
                    ...
                    inputs=[conversation_input, conv_pause, conv_language, conv_seed],
