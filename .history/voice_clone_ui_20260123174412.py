...
def generate_from_design(design_name, clone_text, language, seed, model_size="1.7B", progress=gr.Progress()):
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("🔄 Clone Design"):
                ...
                with gr.Row():
                    ...
                    with gr.Column(scale=1):
                        ...
                        with gr.Row():
                            ...
                            clone_design_model_size = gr.Dropdown(
                                choices=MODEL_SIZES_BASE,
                                value="1.7B",
                                label="Model",
                                info="Base model size",
                                scale=1
                            )
                ...
                clone_design_generate_btn.click(
                    ...
                    inputs=[clone_design_dropdown, clone_design_text, clone_design_language, clone_design_seed, clone_design_model_size],
