        ...
        with gr.Tabs():
            ...
            with gr.TabItem("🎤 Voice Clone"):
                with gr.Row():
                    ...
                    with gr.Column(scale=1):
                        ...
                        with gr.Row():
                            ...
                            play_sample_btn = gr.Button("▶️ Play", size="sm", scale=1)
                    ...
                    with gr.Column(scale=2):
                        ...
                        with gr.Row():
                            ...
                            randomize_seed_btn = gr.Button("🎲", size="sm", scale=0, min_width=40)
                ...
                with gr.Row():
                    ...
                    refresh_outputs_btn = gr.Button("🔄 Refresh", size="sm", scale=1)
